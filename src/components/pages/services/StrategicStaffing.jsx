          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={idx} className="bg-white rounded-2xl shadow-xl p-6 text-center border border-orange-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  <div className="text-4xl mb-4">{category.icon}</div>
                  <h4 className="text-lg font-bold mb-2 text-gray-800">{category.title}</h4>
                  <p className="text-orange-600 font-semibold">{category.count} Available</p>
                </div>
              ))}
            </div>
          </div>
