...
function TechnologyEnablement() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20 relative overflow-hidden">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              <h2 className="text-4xl font-bold mb-8 bg-gradient-to-r from-gray-900 to-emerald-700 bg-clip-text text-transparent">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white px-6 py-8 rounded-xl">
                  <div className="text-3xl font-bold mb-2">400+</div>
                  <div className="text-sm opacity-90">Digital Transformations</div>
                </div>
                <div className="bg-gradient-to-br from-teal-600 to-emerald-700 text-white px-6 py-8 rounded-xl">
                  <div className="text-3xl font-bold mb-2">95%</div>
                  <div className="text-sm opacity-90">Success Rate</div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-emerald-50 to-teal-100 rounded-3xl p-12 shadow-2xl">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={idx} className="flex items-center">
                    <div className="w-6 h-6 bg-gradient-to-r from-emerald-500 to-teal-400 rounded-full flex items-center justify-center mr-4">
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-50 to-teal-100">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          <a
            href="/contact"
            className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white px-10 py-4 rounded-full hover:from-emerald-700 hover:to-teal-800 transition-all duration-300 inline-block font-semibold text-lg shadow-xl transform hover:-translate-y-1"
          >
