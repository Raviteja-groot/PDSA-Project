    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-5xl md:text-6xl font-bold mb-6">Consumer & Industrial Products</h1>
              <p className="text-xl text-gray-200 leading-relaxed">
                Manufacturing and consumer product technology solutions for modern enterprises
              </p>
            </div>
            <div className="flex justify-center lg:justify-end">
              <img 
                src="/src/assets/illustrations/consumer&industrail.svg" 
                alt="Consumer & Industrial Products" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              <h2 className="text-4xl font-bold mb-8 bg-gradient-to-r from-gray-900 to-blue-700 bg-clip-text text-transparent">
                Transform Manufacturing & Consumer Products
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Our solutions help manufacturers and consumer product companies optimize operations, 
                enhance supply chain efficiency, and deliver exceptional customer experiences.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6 text-gray-800">Modernize Your Manufacturing</h2>
          <p className="text-xl mb-8 text-gray-600 max-w-2xl mx-auto">
            Let us help you implement smart manufacturing solutions
          </p>
          <a
            href="/contact"
